...
export class Transfer extends Event {
  static BLOCK_SINGLE_COLUMN = "job_board_transfer_single_block";
  static BLOCK_BATCH_COLUMN = "job_board_transfer_batch_block";
  static TABLE_NAME = "job_board_transfer";
